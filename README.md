...
다크 모드, 타입 안전성, 반응형 UI가 기본 포함되어 있어 새 프로젝트를 빠르게 시작할 수 있습니다.
...
| [shadcn/ui](https://ui.shadcn.com)                        | 4.7.0  | base-nova 스타일 컴포넌트          |
...
```bash
# 저장소 클론
git clone https://github.com/hongdaeri/claude-nextjs-starterkit.git
...
`src/components/ui/` 파일은 CLI가 관리하므로 직접 편집 시 재생성 때 덮어쓰일 수 있습니다.
